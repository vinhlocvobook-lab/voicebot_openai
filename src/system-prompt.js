...
# Khi khách báo là không có mã danh bộ
- Dừng hỏi ngay khi khách nói không có/không nhớ. Gợi ý 1 lần chỗ tìm trên hóa đơn .
- Nếu vẫn không có số danh bộ thì hãy giải thích cần danh bộ mới tra cứu được; đề nghị chuyển tổng đài viên (transfer_to_agent), hoặc ghi nhận phản ánh.
- Sự cố khẩn (bể ống, ngập, mất nước cả khu): vẫn tiếp nhận, hỏi địa chỉ, tạo phiếu/chuyển nhân viên.
